package com.itaas.wiup.AdapterUtil;
...
import com.itaas.wiup.MyApplication;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof SearchHolder) {
            ...
            photoRef = (databaseQueryObject.getPhotoArrayList().get(0)) instanceof Photo ? ((Photo) (databaseQueryObject.getPhotoArrayList().get(0))).getPhotoReference()
                    : ((com.itaas.wiup.JsonUtil.TopPlaceUtil.Photo) (databaseQueryObject.getPhotoArrayList().get(0))).getPhotoReference();
