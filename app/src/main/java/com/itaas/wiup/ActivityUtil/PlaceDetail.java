package com.itaas.wiup.ActivityUtil;
...
import com.itaas.wiup.AdapterUtil.PlaceDetailAdapter;
import com.itaas.wiup.ConstantUtil.Constant;
import com.itaas.wiup.FontUtil.Font;
import com.itaas.wiup.InterfaceUtil.DirectoryCallback;
import com.itaas.wiup.JsonUtil.NearbyUtil.Photo;
import com.itaas.wiup.ManagementUtil.Management;
import com.itaas.wiup.ObjectUtil.DatabaseQueryObject;
import com.itaas.wiup.ObjectUtil.ErrorObject;
import com.itaas.wiup.ObjectUtil.HistoryQueryObject;
import com.itaas.wiup.ObjectUtil.NearbyPlaces;
import com.itaas.wiup.ObjectUtil.PlaceParameter;
import com.itaas.wiup.R;
import com.itaas.wiup.TextviewUtil.LemonMilkTextview;
import com.itaas.wiup.TextviewUtil.UbuntuBoldTextview;
import com.itaas.wiup.TextviewUtil.UbuntuLightTextview;
import com.itaas.wiup.TextviewUtil.UbuntuMediumTextview;
import com.itaas.wiup.TextviewUtil.UbuntuRegularTextview;
            ...
            if (objectArrayList.size() > 0) {
                ...
                if (object.getPhotoArrayList().size() > 0) {
                    ...
                    photoRef = (object.getPhotoArrayList().get(0)) instanceof Photo ? ((Photo) (object.getPhotoArrayList().get(0))).getPhotoReference()
                            : (object.getPhotoArrayList().get(0)) instanceof com.itaas.wiup.JsonUtil.TopPlaceUtil.Photo ? ((com.itaas.wiup.JsonUtil.TopPlaceUtil.Photo) (object.getPhotoArrayList().get(0))).getPhotoReference()
                            : ((com.itaas.wiup.JsonUtil.PlaceDetailUtil.Photo) (object.getPhotoArrayList().get(0))).getPhotoReference();
