...
package com.itaas.wiup.JsonUtil.PlaceDetailUtil;
...
public class Result implements Parcelable
{
    ...
    protected Result(Parcel in) {
        in.readList(this.addressComponents, (com.itaas.wiup.JsonUtil.PlaceDetailUtil.AddressComponent.class.getClassLoader()));
        ...
        in.readList(this.photos, (com.itaas.wiup.JsonUtil.PlaceDetailUtil.Photo.class.getClassLoader()));
        ...
        in.readList(this.reviews, (com.itaas.wiup.JsonUtil.PlaceDetailUtil.Review.class.getClassLoader()));
